...
namespace
{
	DXGI_FORMAT GetFormats(RenderTarget::Format format)
	{
		...
		case RenderTarget::Format::RGBA_F16:
			return DXGI_FORMAT_R16G16B16A16_FLOAT;
		case RenderTarget::Format::RGBA_U32:
			return DXGI_FORMAT_R32G32B32A32_UINT;
		case RenderTarget::Format::R_F16:
			return DXGI_FORMAT_R16_FLOAT;
		case RenderTarget::Format::R_S32:
...
void RenderTarget::UnbindPS(uint32_t slot)
{
	...
	GraphicsSystem::Get()->GetContext()-> PSSetShaderResources(slot, 1, &temp);
}