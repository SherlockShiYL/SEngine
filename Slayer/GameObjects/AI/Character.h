...
public:
	...
	Character(S::AI::AIWorld& world, uint32_t type, uint32_t id);
	...
	void SetPosition(S::Math::Vector2 p)			{ mPosition = p; }
...
protected:
	...
	float mAttackAnimation{ 0.0f }; // when the attack working.
